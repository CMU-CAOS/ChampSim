...
public:
	LearningEngineFeaturewise(champsim::modules::prefetcher *p, float alpha, float gamma, float epsilon, uint32_t actions, uint64_t seed, std::string policy, std::string type, bool zero_init);
