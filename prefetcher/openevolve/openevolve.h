#ifndef PREFETCHER_OPENEVOLVE_H
#define PREFETCHER_OPENEVOLVE_H
...
struct openevolve : public champsim::modules::prefetcher {
  ...
  uint64_t signature_table_reads = 0;
  uint64_t signature_table_writes = 0;
  uint64_t pattern_table_reads = 0;
  uint64_t pattern_table_writes = 0;
  uint64_t prefetch_filter_reads = 0;
  uint64_t prefetch_filter_writes = 0;
  uint64_t global_history_register_reads = 0;
  uint64_t global_history_register_writes = 0;
};
