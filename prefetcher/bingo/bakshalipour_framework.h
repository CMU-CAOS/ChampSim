...
#include <sstream>
#include <algorithm>
#include <cstdint> // ported: Pythia got uint64_t transitively via cache.h
using namespace std;
...
// Ported: was defined in bakshalipour_framework.cc; made inline (header-only)
// so bingo and mlop don't each link a separate definition (ODR/multiple-def).
