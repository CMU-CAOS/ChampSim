...
inline champsim::modules::ModuleBuilder default_memory_controller()
{
    return champsim::modules::ModuleBuilder{}
                              ...
                              .add_parameter("n_rp", static_cast<std::size_t>(18))
                              .add_parameter("n_rcd", static_cast<std::size_t>(18))
                              .add_parameter("n_cas", static_cast<std::size_t>(18))
                              .add_parameter("n_ras", static_cast<std::size_t>(38))
