...
// Self-contained so the header compiles standalone (ChampSim's module build
// includes every module header independently, in unspecified order).
#ifndef MAX_SHCT
#define MAX_SHCT 31
#endif
#ifndef SHCT_SIZE_BITS
...
inline uint64_t CRC( uint64_t _blockAddress )
{
